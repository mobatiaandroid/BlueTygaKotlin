...
class SubDealerRedeemHistoryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sub_dealer_redeem_history)
        context = this
        initialiseUI()
    }
    ...
    private fun initialiseUI() {
        ...
        recyclerRedeemList = findViewById(R.id.recyclerRedeemHistoryList)
        headerManager =
